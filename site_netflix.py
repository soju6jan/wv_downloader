...
from .site_base import SiteBase, d, logger, package_name, ModelSetting, ToolBaseFile, P, webdriver, WebDriverWait, EC, By, Keys
    ...
    def make_download_info(self):
        try:
            ...
            if os.path.exists(json_filepath):
                data = ToolBaseFile.read_json(json_filepath)
            else:
                user_auth_data = {
                ...
                ToolBaseFile.write_json(json_filepath, data)
